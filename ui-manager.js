...
🔸 **동물 시점 (type:"animal" 일 때)**
   고양이: "창가 자리 사수했다냥 #냥스타그램"
   들개: "오늘도 빵집 뒷문 순찰. 소시지 한 조각 획득"
   까마귀: "까악. 반짝이는 거 주웠다"
   비둘기: "공원 벤치 밑 과자 부스러기 대박"
   * 동물체(~냥, ~멍, 짧은 문장) 써도 좋지만 과하게 귀엽게 X
...
JSON만 응답:
{"posts":[
  {"name":"사막여우42","handle":"@desert_fox42","avatar":"🦊","type":"anon","mood":"chill","moodLabel":"😌 나른","text":"해가 쨍쨍. 낮잠 자기 딱 좋은 날씨네 #카자흐스탄 #자연<br><img src='https://image.pollinations.ai/prompt/desert%20afternoon%20sunlight%20peaceful%20cinematic?nologo=true&width=512&height=340' style='width:100%;border-radius:10px;margin-top:8px'>","likes":4},
  ...
  {"name":"길고양이_3번","handle":"@alley_cat3","avatar":"🐱","type":"animal","mood":"chill","moodLabel":"😌 나른","text":"오늘도 빵집 뒷문 성공. 소시지 한 조각 획득했다냥<br><img src='https://image.pollinations.ai/prompt/cute%20alley%20cat%20holding%20food%20backstreet?nologo=true&width=512&height=340' style='width:100%;border-radius:10px;margin-top:8px'>","likes":9}
]}

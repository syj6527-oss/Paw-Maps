    ...
    createSettingsPanel() {
        const html = `<div id="wt-settings" class="wt-settings"><div class="inline-drawer">
            <div class="inline-drawer-toggle inline-drawer-header">
                <b>🐶 World Tracker <span class="wt-version" style="cursor:default;user-select:none">v0.7.1</span></b>
...
**작성 팁:**
- 이름 언급 OK: "${charName}", "${userName}" 직접 써도 되고, 가끔은 "저 남자/여자", "어떤 커플", "~팀"처럼 익명화해도 OK
...
**톤 예시 (카자흐 사막 임무 예시):**
"방금 ${charName}이랑 ${userName} 팀 사막 쪽으로 차 타고 감 미친;; 오늘 임무 또 있나봄"
"아까 ${userName} 표정 진짜 안 좋던데... 뭔 일 있었냐고"
"사막 쪽에서 헬기 소리 들리는데 그 팀 아닌가"
"${charName}이 ${userName}한테 뭐라뭐라 하던데 옆자리라 다 들림ㅋㅋㅋ"

**톤 예시 (교내 카페 싸움 예시):**
"헐 방금 ${charName}이 ${userName}한테 뺨 맞음;;;"
"아 아까 카페에서 커플 싸우던데 대박... 남자 쫓겨남"
"${userName} 울면서 나가는 거 봤는데 무슨 일..."

**톤 예시 (심쿵 목격담):**
"아까 ${charName}이 ${userName} 머리 쓰다듬어주는 거 봤는데 나 녹음ㅠㅠ"
"둘이 같이 커피 마시는데 분위기 대박이었음;; 사귀는 거 맞지?"

**⚠️ 주의:**
- 목격담은 **4~5개 중 1~2개**만. 너무 많으면 어색함.
- 최근 RP에 유저/캐릭터가 이 장소에서 뭘 한 게 없으면 → 억지로 만들지 말고 일반 트윗으로.
- 이들이 직접 트윗을 쓰는 건 절대 금지 (관찰자만).
...
**이 장소가 어느 나라/지역인지 파악해서 현지 색깔을 트윗 1~2개에 꼭 녹여줘.**
장소명, 주소, 메모를 보고 판단. 없으면 장소명으로 추측.

**담아야 할 현지 요소:**
- 🍜 **현지 음식·음료**: 카자흐=라그만/쉬라크(말고기), 한국=뚝배기/배달, 일본=라멘/자판기,
  베트남=쌀국수/반미, 스페인=츄러스/타파스, 터키=차이(홍차), 영국=피쉬앤칩스/티타임,
  멕시코=타코/마르가리타, 태국=팟타이/솜땀, 중국=훠궈/딤섬 등
- 🗣️ **현지 인사·표현 가끔**: "라흐맛~"(카자흐), "그라시아스", "아리가또", "땡큐", "깜싸합니다"
- 🏛️ **현지 문화·관습**: "이 동네 아재 바이브", "할머니가 ~ 해줬음", 현지 호칭(아저씨/아줌마/형님)
- 🌤️ **현지 날씨·환경**: 사막 모래바람, 동남아 스콜, 몽골 바람, 시베리아 추위, 알프스 눈
- 🛒 **현지 생활상**: 한국=배민/지옥철/치킨, 일본=편의점/자판기, 미국=월마트, 유럽=일요일 문닫음

**예시 트윗 (카자흐스탄):**
"아니 어제 마트에서 계산하는데 뒤에 아저씨가 '오늘 저녁은 라그만 어때?' 이러는데 나 울뻔 ㅠㅠㅠ 뭔가 찐 카자흐스탄 아저씨 바이브... #심쿵 #일상"
"사막 모래바람 또 옴 ㅠㅠ 빨래 널어놓은거 다 다시 해야됨"
"마트 가서 쉬라크 샀는데 말고기 냄새 적응 안됨 ㅋㅋㅋㅋ"
...
**예시 트윗 (일본):**
"아 자판기 또 옆에 새로 생김 ㅋㅋㅋ 이 동네 자판기 밀도 세계 1위 아니냐"
"편의점 오뎅 미쳤다 진짜... 겨울 왔구나 실감남ㅠㅠ"

**예시 트윗 (베트남):**
"아침부터 쌀국수 한 그릇 때림... 3천원 실화 ㅠㅠㅠ"
"스콜 또 옴 우산 의미없는 동네"

**현지 해시태그 활용:** #카자흐스탄, #라그만, #지옥철, #배민, #스콜, #자판기투어 등

**⚠️ 주의:**
- 현지색 **1~2개 포스트에만** 녹여. 5개 전부는 오버.
- 장소가 **가상/판타지** (성, 던전, 우주선 등)면 그 세계관 색깔로 반영 (중세 음식, SF 용어 등).
- 장소가 실내·일반적 공간 (방, 사무실, 카페)이면 도시/나라 특색으로 반영.
...
JSON만 응답:
{"posts":[
  {"name":"카자흐거주민","handle":"@local_kazakh","avatar":"😊","type":"anon","mood":"romantic","moodLabel":"😊 기쁨","text":"아니 어제 마트에서 계산하는데 뒤에 아저씨가 '오늘 저녁은 라그만 어때?' 이러는데 나 울뻔 ㅠㅠㅠ 뭔가 찐 카자흐스탄 아저씨 바이브... #심쿵 #일상<br><img src='https://image.pollinations.ai/prompt/kazakh%20market%20locals%20warm%20atmosphere?nologo=true&width=512&height=340' style='width:100%;border-radius:10px;margin-top:8px'>","likes":9,"replies":[{"name":"라그만러버","handle":"@laghman_lover","avatar":"🍜","text":"라그만 존맛탱이죠ㅠㅠㅠ"}]},
  {"name":"카자흐_구경꾼","handle":"@kz_watcher","avatar":"👀","type":"anon","mood":"excited","moodLabel":"🔥 목격","text":"방금 ${charName}이랑 ${userName} 팀 사막 쪽으로 차 타고 감 미친;; 또 임무임?? 저 사람들은 언제 쉬냐ㅠ #${charName}","likes":12,"replies":[{"name":"궁금맨","handle":"@curious_0","avatar":"👀","text":"헐 어디로요??"},{"name":"소문쟁이","handle":"@gossip_lord","avatar":"💭","text":"얼마전에도 갔잖아 이 팀 진짜 일 많다..."}]},
  {"name":"사막여우42","handle":"@desert_fox42","avatar":"🦊","type":"anon","mood":"chill","moodLabel":"😌 나른","text":"사막 모래바람 또 옴 ㅠㅠ 빨래 널어놓은거 다 다시 해야됨 아 진짜<br><img src='https://image.pollinations.ai/prompt/desert%20sandstorm%20laundry%20windy%20day?nologo=true&width=512&height=340' style='width:100%;border-radius:10px;margin-top:8px'>","likes":4,"replies":[{"name":"나른한사람","handle":"@sleepy_one","avatar":"😌","text":"ㄹㅇ 이 동네 왜이럼ㅠㅠ"}]},
  {"name":"Quarters_rat","handle":"@q_rat","avatar":"🤔","type":"anon","mood":"tense","moodLabel":"😵 멘붕","text":"또 와이파이 끊김 ㅋㅋㅋㅋㅋㅋㅋ 이 동네 통신사 어떻게 1년째 이럼?ㅠㅠ","likes":11,"replies":[{"name":"공감러","handle":"@same_here","avatar":"🫠","text":"나두 어제부터 계속 끊겨ㅠㅠㅠ"}]},
  {"name":"길고양이_3번","handle":"@alley_cat3","avatar":"🐱","type":"animal","mood":"chill","moodLabel":"😌 나른","text":"오늘도 빵집 뒷문 클리어 소시지 득템<br><img src='https://image.pollinations.ai/prompt/cute%20alley%20cat%20holding%20food%20backstreet?nologo=true&width=512&height=340' style='width:100%;border-radius:10px;margin-top:8px'>","likes":9,"replies":[{"name":"냥덕","handle":"@cat_lover99","avatar":"🐈","text":"너무 귀여움ㅠㅠㅠㅠ"}]}
]}
...
JSON만 응답. 앞뒤에 설명·코드블록·주석 금지.`;
            ...
            for (const p of parsed.posts.filter(p => p && p.text)) {
                ...
                // v0.7.1: 답글 정제 (name/handle/avatar/text만 유지, 최대 3개)
            ...
            if (!this._commOverlayOpen) {
                ...
                // v0.7.1: 현재 활성 탭 기억 → 재렌더 후 복원 (🟢 실시간 탭에서 생성 시 탭 유지)
    ...
    // v0.7.1: 이모지/멀티바이트 문자의 첫 grapheme만 추출 (아바타 overflow 방지)
    _firstGrapheme(s) {
        if (!s) return '👤';
        try {
    ...
    _renderCommunityPostCard(p) {
        ...
        // v0.7.1: 아바타 정규화 — 이모지 2~3개 겹친 거("🍯🦡", "1️⃣4️⃣1️⃣") 터지지 않도록 첫 grapheme만 사용
        const avatarChar = this._firstGrapheme(p.avatar || (p.type === 'animal' ? '🐾' : '👤'));
        // v0.7.1: 답글 렌더링 (트위터 스타일 — 왼쪽 살짝 들여쓰기 + 가는 선)
